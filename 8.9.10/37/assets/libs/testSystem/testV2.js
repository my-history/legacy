$().ready(function () {
	...
	$('#answerImg0').on('click', function() {

		$('#answerImg0').addClass('answerImgInner__active')


		if($('#answerImg1').hasClass('answerImgInner__active')) {
			$('#answerImg1').removeClass('answerImgInner__active')
		}

		if ($('#answerImg2').hasClass('answerImgInner__active')) {
			$('#answerImg2').removeClass('answerImgInner__active')
		}

		if ($('#answerImg3').hasClass('answerImgInner__active')) {
			$('#answerImg3').removeClass('answerImgInner__active')
		}


	})

	$('#answerImg1').on('click', function() {

		$('#answerImg1').addClass('answerImgInner__active')


		if($('#answerImg0').hasClass('answerImgInner__active')) {
			$('#answerImg0').removeClass('answerImgInner__active')
		}
	...
	$('#answerImg2').on('click', function() {

		$('#answerImg2').addClass('answerImgInner__active')
	...
	$('#answerImg3').on('click', function() {

		$('#answerImg3').addClass('answerImgInner__active')
	...
	$('#answer0').on('click', function () {
		...
		$('#answer0').addClass('textAnswer__active')


		if ($('#answer1').hasClass('textAnswer__active')) {
			$('#answer1').removeClass('textAnswer__active')
		}

		if ($('#answer2').hasClass('textAnswer__active')) {
			$('#answer2').removeClass('textAnswer__active')
		}

		if ($('#answer3').hasClass('textAnswer__active')) {
			$('#answer3').removeClass('textAnswer__active')
		}
	...
	$('#answer1').on('click', function () {
		...
		$('#answer1').addClass('textAnswer__active')


		if ($('#answer0').hasClass('textAnswer__active')) {
			$('#answer0').removeClass('textAnswer__active')
		}
	...
	$('#answer2').on('click', function () {
		...
		$('#answer2').addClass('textAnswer__active')
	...
	$('#answer3').on('click', function () {
		...
		$('#answer3').addClass('textAnswer__active')
...
function variables() { //Все используемые переменные
	...
	$quiz = [
		...
		//Вопрос 1
		{
			...
			"questionImg": "../assets/img/main/klementyevaHouse.jpg",
			"textAnswers": [
				"Клементьевой А. А.",
				"Дудину М.А.",
				"Горбунову Г.К.",
		...
		//Вопрос 3
		{
			...
			"questionImg": "../assets/img/main/KrasnayaCerkov.jpg",
			"textAnswers": [
		...
		//Вопрос 5
		{
			...
			"questionImg": "../assets/img/main/Xirurgiya.jpg",
			"textAnswers": [
		...
		//Вопрос 6
		{
			...
			"textAnswers": [],
			"imgAnswers": [
				"../assets/img/main/KrasnayaCerkov.jpg", "../assets/img/main/XramPokrova.jpg", "../assets/img/main/WhiteCerkov.jpg", "../assets/img/main/someChurch.jpg"
			],
		...
		{
			"question": "Как называется этот храм?",
			"questionImg": "../assets/img/main/XramPokrova.jpg",
			"textAnswers": [
				"Церковь Покрова Пресвятой богородицы",
				"Храм Вознесения Господня",
				"Храм Спас на Крови",
		...
		//Вопрос 8
		{
			...
			"questionImg": "../assets/img/main/sovetskaya_f.jpg",
			"textAnswers": [
		...
		{
			"question": "Как называется этот храм?",
			"questionImg": "../assets/img/main/WhiteCerkov.jpg",
			"textAnswers": [
				"Храм Вознесения Господня",
				"Храм Спаса на Крови",
				"Храм иконы Божьей Матери Всех Скорбящих Радости",
		...
		//Вопрос 10
		{
			...
			"questionImg": "../assets/img/main/nijnii_dvor_f.jpg",
			"textAnswers": [
				"Школа для рабочих",
				"Рабочие казармы",
				"Техническое училище",
		...
		//Вопрос 18
		{
			...
			"questionImg": "../assets/img/main/Gorbunov.jpg",
			"textAnswers": [
				"В.А.Лапшину",
				"Д.А.Фурманову",
				"Д.А.Трубникову",
