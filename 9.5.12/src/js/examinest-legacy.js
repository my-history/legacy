...
function showLoading() {
  ...
  $loader.removeClass('l-dn');
  $testScreen.addClass('l-dn');
  $testScreenChilds.addClass('l-dn')
  $questionImg.addClass('l-dn')
}

function hideLoading() {
  $loader.addClass('l-dn')
  $testScreen.removeClass('l-dn')
  $testScreenChilds.removeClass('l-dn')
  $questionImg.addClass('l-dn')
