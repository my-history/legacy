...
function Selectors() {
	...
	this.startScreen = $('[data-test-role="startScreen"]');
	this.startScreenChilds = $('[data-test-role="startScreen"] *');

	//Start screen items

	this.startTestButton = $('[data-test-role="startTestButton"]');

	//Loading screen

	this.loadingScreen = $('[data-test-role="loadingScreen"]');

	//Test screen

	this.testScreen = $('[data-test-role="testScreen"]');
	this.testScreenChilds = $('[data-test-role="testScreen *"]');

	//Finish screen

	this.finishScreen = $('[data-test-role="finishScreen"]');
	this.finishScreenChilds = $('[data-test-role="finishScreen"] *');
	this.userResult = $('[data-test-role="userResult"]');
	this.totalQuestions = $('[data-test-role="totalQuestions"]');
	this.restartTestButton = $('[data-test-role="restartTestButton"]');

	//Questions' data fields

	this.numberOfQuestion = $('[data-test-role="numberOfQuestion"]');
	this.textOfQuestion = $('[data-test-role="textOfQuestion"]');

	this.innerOfImageOfQuestion = $('[data-test-role="innerOfImageOfQuestion"]');
	this.imageOfQuestion = $('[data-test-role="imageOfQuestion"]');
...
function Loading() {
	this.show = function () {
		Selectors.loadingScreen.css('display', 'flex');
		Selectors.testScreen.css('display', 'none');
		Selectors.testScreenChilds.css('display', 'none');
	}

	this.hide = function () {
		Selectors.loadingScreen.css('display', 'none');
		Selectors.testScreen.css('display', 'flex');
		Selectors.testScreenChilds.css('display', 'flex');
	}
}
